...
<head>
    <title>QTD Store - Tìm kiếm sản phẩm</title>
            ...
            <div class="col-xl-10 content">
                <div class="main-content">
                    ...
                    <ul class="clear order-list">
                        <li class="active">
                            <a href="?mod=product">Tất cả (<span class="num">20</span>)</a>
                        </li>
                        <?php
                        $list_cat = get_cat();
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="select[]" id="select-<?php echo $item['product_id'] ?>">
                                            </td>
                                            <td><?php echo $temp ?></td>
                                            <td><a href="?mod=category&action=detail&id=<?php echo $item['product_id'] ?>"><?php echo $item['product_code'] ?></a></td>
                                            <td><a href="?mod=category&action=detail&id=<?php echo $item['product_id'] ?>" class="product-thumb"><img src="<?php echo get_thumb_url($item['img_id']) ?>"></a></td>
