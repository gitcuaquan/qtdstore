            ...
            <div class="col-xl-10 content">
                <div class="main-content">
                    ...
                    <ul class="clear order-list">
                        ...
                        <li>
                            <a href="">Thành viên thường (<span class="num">20</span>)</a>
                        </li>
                        <li>
                            <a href="">Thành viên VIP (<span class="num">20</span>)</a>
                        </li>
                        <li>
                    ...
                    <form action="" method="get">
                        ...
                        <input type="text" name="search" placeholder="Nhập tên đăng nhập..." id="search-box">
